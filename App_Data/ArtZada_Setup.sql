...
--     Paste this entire file > Click the Run (â–¶) button
--
...
-- ============================================================
-- STEP 2: Drop tables (safe reset â€” in reverse FK order)
-- ============================================================
...
INSERT INTO dbo.Users (
    ...
    'admin',
    'admin@qcu.edu.ph',
    'ACC6U5RMpYLOTYIeQiVXbal1Qj1fwt7YP6ayarvr3AWScJ6Kk9xd/aKvlmINwLSI1g==',
...
INSERT INTO dbo.Users (
    ...
    1,
    1,
    'Digital Artist Â· Illustrator Â· Concept Artist'
);
GO
...
-- ============================================================
-- STEP 6: Verify â€” show row counts for all tables
-- ============================================================
